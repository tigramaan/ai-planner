...
| --- | --- | --- | --- | --- |
| api | Auth, integrations, agent and planner data | `contracts/auth-service.md`, `integration-service.md`, `agent-service.md`, `planner-service.md` | `/health/live`, `/health/ready` | MVP |
