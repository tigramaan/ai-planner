...
## REQ-084 — Гибкий поиск задач, напоминаний и событий

1. Создать напоминание «Отправить техзадание Роману в самолёт», затем командой «Поменяй напоминание Роману на 13:20» убедиться, что меняется самостоятельное напоминание, а не ищется задача.
2. Найти задачу и календарное событие по фрагменту, переставленным словам и близкой словоформе; точное название не должно требоваться.
