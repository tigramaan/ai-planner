...
Public project acceptance (2026-08-03, updated 2026-08-04): Gitleaks reports zero findings across repository history and the README, Pages, skill, workflows and security policy. CI checks out full history and blocks future leaks. The responsive GitHub Pages landing is text-led, renders from 320 to 1440 px, explains concrete product scenarios, installation, provider support, security boundaries and contribution paths without decorative product mockups. The repository `deploy-aiplanner` skill passes the official skill validator and explicitly prevents secret disclosure while configuring OpenAI, Google, Microsoft, Zoom, Yandex 360 and web push.
