...
- REQ-062: The public repository provides a Russian-first README, responsive text-led GitHub Pages product/install site, private vulnerability reporting guidance, full-history secret scanning in CI, and a validated agent skill for secure self-hosted deployment and provider onboarding.
- REQ-063: Public documentation contains no personal mailbox/chat data, explains product capabilities and safety boundaries through concrete text scenarios without decorative product mockups, and is distributed under the MIT license. Successful interactive Web actions expose a localized, accessible, transient outcome notification.
